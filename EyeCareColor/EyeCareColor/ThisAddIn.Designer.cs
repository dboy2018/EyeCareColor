...
namespace EyeCareColor {
    ...
    internal sealed partial class Globals {
        ...
        {
            var color = Color.FromArgb(204,232,207);
            var colorInt = ParseRGB(color);
            ChangeBackground(colorInt);
        }
        ...
        private static void ChangeBackground(int colorInt)
        {
            try
            {
                _ThisAddIn.Application.ActiveDocument.Background.Fill.ForeColor.RGB = colorInt;
                _ThisAddIn.Application.ActiveDocument.Background.Fill.Solid();
                _ThisAddIn.Application.ActiveWindow.View.DisplayBackgrounds = true;
            }
            catch
            {
        ...
        private static int ParseRGB(Color color)
        {
